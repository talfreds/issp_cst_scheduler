...
var get_instructor_class_list = (instructor_id) => {
    return new Promise((resolve, reject) => {
        var query = `SELECT classroomcourse.courseID, classroomcourse.instructorID, classroomcourserecord.learnerID, learner.learnerLastname, learner.learnerFirstName, klr.klrID, klr.klrName, classroomcourserecord.JIRA
        FROM classroomcourse
