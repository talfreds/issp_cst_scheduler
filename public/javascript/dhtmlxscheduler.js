...
window.dhtmlXScheduler = window.scheduler = { version: "5.1.6" }, window.dhtmlx || (dhtmlx = function(e) { for (var t in e) dhtmlx[t] = e[t]; return dhtmlx }), dhtmlx.extend_api = function(e, t, i) {
    ...
    function() {
        ...
        }, dhtmlx.confirm = function() { var e = h.apply(this, arguments); return e.type = e.type || "alert", o(e) }, dhtmlx.modalbox = function() { var e = h.apply(this, arguments); return e.type = e.type || "alert", l(e) }, dhtmlx.modalbox.hide = function(e) {
...
dataProcessor.prototype = {
        ...
        markRow: function(e, t, i) {
            var r = "",
                s = this.is_invalid(e);
            if (s && (r = this.styles[s], t = !0), this.callEvent("onRowMark", [e, t, i, s]) && (r = this.styles[t ? i : "clear"] + r, this.obj[this._methods[0]](e, r), s && s.details)) { r += this.styles[s + "_cell"]; for (var a = 0; a < s.details.length; a++) s.details[a] && this.obj[this._methods[1]](e, a, r) }
        },
        getState: function(e) {
        ...
        _sendData: function(e, t) {
            if (e) {
                ...
                if ("GET" == this._tMode) s.query({ url: n + s.urlSeparator(n) + this.serialize(e, t), method: "GET", callback: r, headers: this._headers });
                    ...
                    delete o[this.action_param], delete o.id, delete o.gr_id, s.query({ url: n, method: "POST", headers: this._headers, callback: r, data: JSON.stringify({ id: t, action: d, data: o }) })
    ...
    scheduler._detachDomEvent = function(e, t, i) { e.removeEventListener ? e.removeEventListener(t, i, !1) : e.detachEvent && e.detachEvent("on" + t, i) }, scheduler._init_once = function() {
        ...
        buttons: {
            ...
            edit: function(e) { scheduler.showLightbox(e) },
            save: function(e) { scheduler.showLightbox(e) },
            details: function(e) { scheduler.showLightbox(e) },
            cancel: function(e) { scheduler.showLightbox(e) }
        }
        ...
        if (t = t || e.target || e.srcElement, !this.config.readonly) {
            ...
            switch (i) {
                ...
                case "dhx_cal_event_clear":
                    ...
                    this.config.details_on_dblclick || this._table_view || !this.getEvent(r)._timed || !this.config.select ? this.showLightbox(r) : this.showLightbox(r);
                    break;
                case "dhx_time_block":
        ...
        return i
    }, scheduler._get_timeunit_start = function() { return this.date[this._mode + "_start"](new Date(this._date.valueOf())) }, scheduler._get_view_end = function() {
        ...
        return ""
    }, scheduler.updateCollection = function(e, t) { var i = scheduler.serverList(e); return i ? (i.splice(0, i.length), i.push.apply(i, t || []), scheduler.callEvent("onOptionsLoad", []), scheduler.resetLightbox(), !0) : !1 }, scheduler._lame_clone = function(e, t) {
        var i, r, s;
    ...
    }, scheduler.getActionData = function(e) { var t = this._mouse_coords(e); return { date: this._get_date_from_pos(t), section: t.section } }, scheduler._focus = function(e, t) {
        if (e && e.focus)
            if (this._mobile) window.setTimeout(function() { e.focus() }, 10);
            else try { t && e.select && e.offsetWidth && e.select(), e.focus() } catch (i) {}
        ...
        _call: function(e, t, i, r, s, a, n) {
            ...
            if (r && (o.onreadystatechange = function() {
                    if (4 == o.readyState || l && 3 == o.readyState) {
                        ...
                        window.setTimeout(function() { "function" == typeof s && s.apply(window, [{ xmlDoc: o, filePath: t }]), a && ("undefined" != typeof a.postData ? this.postLong(a.url, a.postData, s) : this.getLong(a.url, s)), s = null, o = null }, 1)
                    }
    ...
    function() {
            ...
            if (a) {
                ...
                if (this._waiAria.eventAttr(e, v), this._rendered.push(v), t.appendChild(v), c = c + parseInt(a.style.left, 10) + s, this._edit_id == e.id) {
                    ...
                    this.set_xy(p, _ - 6, o - 26), p.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", v.appendChild(p), this._els.dhx_cal_data[0].appendChild(v), this._rendered.push(v), p.innerHTML = "<textarea class='dhx_cal_editor'>" + e.text + "</textarea>", this._quirks7 && (p.firstChild.style.height = o - 12 + "px"), this._editor = p.firstChild,
                        ...
                        }, this._editor.onselectstart = function(e) { return (e || event).cancelBubble = !0, !0 }, scheduler._focus(p.firstChild, !0), this._els.dhx_cal_data[0].scrollLeft = 0
                }
    ...
    }, scheduler.locate_holder_day = function(e, t) { var i = Math.floor((this._correct_shift(e, 1) - this._min_date) / 864e5); return t && this.date.time_part(e) && i++, i }, scheduler._get_dnd_order = function(e, t, i) {
        ...
        return i
    }, scheduler.getRenderedEvent = function(e) { if (e) { for (var t = scheduler._rendered, i = 0; i < t.length; i++) { var r = t[i]; if (r.getAttribute("event_id") == e) return r } return null } }, scheduler.showEvent = function(e, t) {
        ...
        for (var r = scheduler.$ajax.xpath("//coll_options", e.xmlDoc), s = 0; s < r.length; s++) {
            ...
            for (var d = scheduler.$ajax.xpath(".//item", r[s]), o = 0; o < d.length; o++) {
                for (var l = d[o], h = l.attributes, _ = { key: d[o].getAttribute("value"), label: d[o].getAttribute("label") }, c = 0; c < h.length; c++) { var u = h[c]; "value" != u.nodeName && "label" != u.nodeName && (_[u.nodeName] = u.nodeValue) }
                n.push(_)
            }
        }
    ...
    }, scheduler.startLightbox = function(e, t) { this._lightbox_id = e, this._custom_lightbox = !0, this._temp_lightbox = this._lightbox, this._lightbox = t, this.showCover(t) }, scheduler.endLightbox = function(e, t) {
